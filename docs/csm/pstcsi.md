...
### 6.下載values.yaml
```
wget -O values.yaml https://github.com/dell/helm-charts/raw/csi-powerstore-2.11.0/charts/csi-powerstore/values.yaml
```
...
```
./csi-install.sh --namespace ps --values ./values.yaml --skip-verify-node     # ps為Name Space，依據需求自定義
```
